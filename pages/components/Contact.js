...
export default class Contact extends Component {
    render() {
        return (
            <div className="bg-yellow-300 rounded mb-10 shadow-md">
                <div className="m-10">
                ...
                <div className="justify-self-center mt-8 flex flex-col">
                    ...
                    <div className="grid grid-cols-2 gap-x-20">
                        <div className="grid grid-cols-1 grid-rows-1">
                            ...
                            <input className="w-60 h-10 border-black border rounded" type="text" id="firstName" name="name" />
                        </div>
                        <div className="grid grid-cols-1 grid-rows-2">
                            <label htmlFor="name">Last Name</label>
                            <input className="w-60 h-10 border-black border rounded" type="text" id="lastName" name="name" />
                        </div>
                    </div>
