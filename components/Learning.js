        ...
        return (
            ...
            <div className="justify-items-center grid sm:grid-cols-3 sm:h-64" data-aos={"fade-up"}>
                <div className="sm:col-span-2 sm:w-96" data-aos={"fade-up"}>
                    <h1 className="justify-self-center sm:flex sm:h-auto sm:w-100 text-xl sm:text-5xl sm:text-left text-center sm:right-0">What I'm Currently Learning </h1>
                    <div className="justify-self-center sm:w-auto mt-5 w-60 text-center sm:text-left">{learningDescription}</div>
                </div>
                <div className="sm:block hidden sm:w-64 sm:h-64 sm:m-0 sm:top-20">
                    <img className="sm:w-128 sm:h-128 sm:m-0" src='svg/manLamp.svg' alt="floating cloud me! hummann"/>
                </div>
            </div>
