...
export default class Strengths extends Component {
    render() {
        return (
            <div id="projects" className="relative z-10 flex flex-col justify-center items-center bg-white h-192 w-screen" >
            <h1 className="flex w-33 h-15 text-5xl text-center mt-5" data-aos={"fade-up"}>Strengths</h1>
            <div className="hidden xl:block absolute mx-32 right-0 object-right w-64 h-64 m-0 top-20" data-aos={"fade-up"}>
